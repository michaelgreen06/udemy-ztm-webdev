...
function adddel(){
	for (var i = 0; i< gli.length; i++) {
		...
		ddbtn.addEventListener("click",remove1);
		// ddbtn.onclick=function(){
		// 	gli[i].remove();
		// }
		//this below code was suggested by ascii and also works!
		// gli[i].appendChild(document.createElement("button")).appendChild(document.createTextNode("Delete"));
